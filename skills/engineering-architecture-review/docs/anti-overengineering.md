...
- Service extraction without clear independent deployment, ownership, scaling, reliability, or compliance benefit.
...
Architectural correctness is not enough. The change must improve maintainability, reliability, delivery speed, operational safety, ownership, compliance, or business continuity enough to justify its cost.
