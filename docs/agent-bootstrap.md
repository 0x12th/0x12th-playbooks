...
Use engineering-architecture for architecture review, architecture decisions, migrations, service boundaries, domain boundaries, ownership, data ownership, system evolution, product evolution, roadmap planning, design challenge, tradeoff analysis, and technical decision support.
...
If both skills seem relevant, decide architecture first with engineering-architecture, then use engineering-delivery for implementation.
